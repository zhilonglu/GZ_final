def writeToM():
    ...
    path = "C:\\Users\\NLSDE\\Workspaces\\MyEclipse 2015\\lzl\\BPNN_v2AliyunMR\\warehouse\\buaa_prj\\__tables__\\wc_in\\M000001"
    inpath = "C:\\Users\\NLSDE\\Desktop\\gz\\"
    with open(path,"w") as f1:
        with open(inpath+"tensor_fill_wan_link_all.csv") as f:
            lines = f.readlines()
            for line in lines:
                f1.write(line)
def writeFromR():
    inpath = "C:\\Users\\NLSDE\\Workspaces\\MyEclipse 2015\\lzl\\BPNN_v2AliyunMR\\warehouse\\buaa_prj\\__tables__\\wc_out\\R_000000"
    outpath = "C:\\Users\\NLSDE\\Desktop\\icdm\\final_tables\\"
    file = ["knn_link_zao.txt","knn_link_zhong.txt","knn_link_wan.txt"]
    with open(outpath+"sv_bpv2_wan_seg1.txt","w") as f1:
